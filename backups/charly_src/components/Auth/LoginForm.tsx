...
export const LoginForm: React.FC = () => {
  ...
  const handleGoogleSignIn = isGoogleOAuthAvailable() 
    ? useGoogleLogin({
        onSuccess: async (response) => {
          try {
            ...
            // IMMEDIATELY set a flag to prevent any rendering
            ...
            if (userInfo.email) {
              ...
              try {
                ...
                if (walletsResponse.data.wallets && walletsResponse.data.wallets.length > 0) {
                  ...
                  // IMMEDIATE redirect to signup
                  console.log('🚀 IMMEDIATE redirect to signup using window.location');
